...
public interface MessageSerializationFactory {
  ...
  /**
   * @param messageType
   *                    the type of message that the new {@link MessageSerializer}
   *                    should
   *                    serialize
  ...
  /**
   * @param messageType
   *                    the type of message that the new
   *                    {@link MessageDeserializer}
   *                    should deserialize
  ...
  /**
   * @param serviceType
   *                    the type of service that the new {@link MessageSerializer}
   *                    should
  ...
  /**
   * @param serviceType
   *                    the type of service that the new
   *                    {@link MessageDeserializer}
