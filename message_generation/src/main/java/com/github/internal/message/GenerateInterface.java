...
public class GenerateInterface {
  ...
  public static void main(String[] args) {
    ...
    if (extension.equals("msg")) {
      ...
      MessageDeclaration requestDeclaration = MessageDeclaration.of(messageIdentifier.getType() + "Request",
          requestAndResponse.get(0));
      MessageDeclaration responseDeclaration = MessageDeclaration
