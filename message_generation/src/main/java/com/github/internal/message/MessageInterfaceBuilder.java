...
import com.github.internal.message.context.MessageContext;
import com.github.internal.message.context.MessageContextProvider;
import com.github.internal.message.field.Field;
import com.github.internal.message.field.FieldType;
import com.github.internal.message.field.MessageFields;
...
public class MessageInterfaceBuilder {
  ...
  /**
   * @param packageName
   *                    the package name of the interface or {@code null} if no
   *                    package
  ...
  public String build(MessageFactory messageFactory) {
    ...
    builder.append(String.format(
        "public interface %s extends com.github.internal.message.Message {\n", interfaceName));
